...
from src.indexer import close_db, get_all_documents, get_document_count, init_db, insert_document, is_document_indexed
...
from src.vector_search import embed_document, has_embeddings, init_vector_table, semantic_search
